...
public class Permission {
	...
	String[][] Data=Read_Data.ReadData("Permissions.csv");
	...
	driver.get("http://amrita.inpods.com");// Maximize the window.
  ...
  Thread.sleep(2000);
	driver.findElement(By.xpath(".//*[@id='UserName']")).sendKeys("inpodssa@amrita.bl.edu");
	Thread.sleep(2000);
	driver.findElement(By.xpath(".//*[@id='Password']")).sendKeys("amritaipds");
	Thread.sleep(2000);
